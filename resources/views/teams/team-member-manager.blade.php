<div>
            ...
            <x-form-section submit="addTeamMember">
                ...
                <x-slot name="form">
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <x-input id="name" type="text" class="mt-1 block w-full" wire:model="addTeamMemberForm.email" />
                ...
                <x-slot name="actions">
                    ...
                    <x-button class="bg-red-800 hover:bg-red-700 text-white">
                        {{ __('Add') }}
                    </x-button>
                </x-slot>
            </x-form-section>
    ...
    <x-dialog-modal wire:model.live="currentlyManagingRole">
        ...
        <x-slot name="footer">
            ...
            <x-button class="ml-2 bg-red-800 hover:bg-red-700 text-white" wire:click="updateRole" wire:loading.attr="disabled">
                {{ __('Save') }}
            </x-button>
        </x-slot>
    </x-dialog-modal>
