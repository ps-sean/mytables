<x-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="flex items-center mt-5">
            <x-button class="bg-red-800 hover:bg-red-700 text-white" wire:click="confirmLogout" wire:loading.attr="disabled">
        ...
        <x-dialog-modal wire:model.live="confirmingLogout">
            ...
            <x-slot name="footer">
                ...
                <x-button class="ml-2 bg-red-800 hover:bg-red-700 text-white" wire:click="logoutOtherBrowserSessions" wire:loading.attr="disabled">
                    {{ __('Logout Other Browser Sessions') }}
                </x-button>
            </x-slot>
        </x-dialog-modal>
